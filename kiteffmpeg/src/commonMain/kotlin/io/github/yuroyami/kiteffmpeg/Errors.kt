...
public sealed class FFmpegError(public val code: Int, public val message: String) {
    ...
    /**
     * The linked FFmpeg runtime does not match the headers KiteFFmpeg's C layer was compiled against,
     * so KiteFFmpeg refused to use it.
     *
     * Deliberately its own class and not an [Internal]: nothing about it is a bug in KiteFFmpeg, it is
     ...
     *
     * [code] is 0, like [Internal]'s, on purpose. The verdict is a KiteFFmpeg status and not an
