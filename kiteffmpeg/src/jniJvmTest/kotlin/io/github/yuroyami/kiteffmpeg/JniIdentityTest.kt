...
class JniIdentityTest {
    ...
    fun identityHasAllTypedFieldsAndTheCurrentAbi() {
        // The pin is deliberate: an ABI bump nobody wrote down must fail here. 3.7 adds the format
        // and implementation lookups; move this with KITECODEC_C_ABI_MAJOR and _MINOR only.
